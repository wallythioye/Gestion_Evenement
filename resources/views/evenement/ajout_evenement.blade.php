    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="scrolling-text">
                <h2>Bienvenue {{ Auth::user()->prenom }} {{ Auth::user()->nom}} Voici La Page Pour Ajouter Un Evenement</h2>
            </div>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">AJOUT EVENEMENT</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('evenement.ajout_traitement') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lieu') is-invalid @enderror" id="lieu" name="lieu" required>
                        </div>
